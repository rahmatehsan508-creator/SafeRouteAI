  ...
  return (
    <div className="py-8 px-4 lg:px-8 max-w-6xl mx-auto space-y-10 relative">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-5">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/15 border border-emerald-400/30 text-emerald-300 text-xs font-semibold backdrop-blur-xl shadow-[0_0_15px_rgba(16,185,129,0.2)]">
          <Shield className="w-3.5 h-3.5 text-emerald-400" />
          <span>Dynamic Urban Safety Intelligence</span>
        </div>

        <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-100 tracking-tight leading-tight drop-shadow-sm">
          Choose routes based on <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-400">more than speed</span>.
        </h1>
      ...
      <div className="glass-panel rounded-2xl p-5 sm:p-6 space-y-4 shadow-2xl border border-white/10">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2 text-xs font-bold text-slate-200">
            <Sparkles className="w-4 h-4 text-emerald-400" />
            <span>Sample Demonstration Corridors (Real Geocoding & Routing)</span>
          </div>
          <span className="text-[11px] text-slate-400 font-light">Click to instantly calculate live routes & safety scores</span>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <button
            onClick={() => onQuickRouteSelect('Victoria Memorial, Kolkata', 'Howrah Station, Kolkata')}
            className="text-left p-3.5 rounded-xl glass-card hover:bg-white/[0.08] border border-white/[0.08] hover:border-emerald-400/50 transition-all duration-200 group shadow-md"
          >
            <div className="text-[10px] font-mono text-emerald-400 font-bold mb-1 tracking-wider uppercase">Kolkata Urban Core</div>
            ...
            <div className="text-[11px] text-slate-400 mt-1 flex items-center gap-1.5 font-light">
          ...
          <button
            ...
            className="text-left p-3.5 rounded-xl glass-card hover:bg-white/[0.08] border border-white/[0.08] hover:border-emerald-400/50 transition-all duration-200 group shadow-md"
          >
            <div className="text-[10px] font-mono text-emerald-400 font-bold mb-1 tracking-wider uppercase">Tech Corridor Commute</div>
            <div className="text-xs font-bold text-slate-100 group-hover:text-emerald-300 transition-colors">
          ...
          <button
            ...
            className="text-left p-3.5 rounded-xl glass-card hover:bg-white/[0.08] border border-white/[0.08] hover:border-emerald-400/50 transition-all duration-200 group shadow-md"
          >
            <div className="text-[10px] font-mono text-emerald-400 font-bold mb-1 tracking-wider uppercase">Manhattan Midtown</div>
            <div className="text-xs font-bold text-slate-100 group-hover:text-emerald-300 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="glass-panel p-5 rounded-2xl space-y-2.5 border border-white/10 shadow-xl">
          <div className="w-9 h-9 rounded-xl bg-emerald-500/15 border border-emerald-400/30 flex items-center justify-center text-emerald-400 shadow-[0_0_12px_rgba(16,185,129,0.2)]">
            <Eye className="w-4 h-4" />
          </div>
          <h2 className="text-sm font-bold text-slate-100">Multi-Factor Safety Engine</h2>
        ...
        <div className="glass-panel p-5 rounded-2xl space-y-2.5 border border-white/10 shadow-xl">
          <div className="w-9 h-9 rounded-xl bg-amber-500/15 border border-amber-400/30 flex items-center justify-center text-amber-400 shadow-[0_0_12px_rgba(245,158,11,0.2)]">
            <AlertCircle className="w-4 h-4" />
          </div>
          <h2 className="text-sm font-bold text-slate-100">Community Safety Reports</h2>
          <p className="text-xs text-slate-400 leading-relaxed font-light">
        ...
        <div className="glass-panel p-5 rounded-2xl space-y-2.5 border border-white/10 shadow-xl">
          <div className="w-9 h-9 rounded-xl bg-indigo-500/15 border border-indigo-400/30 flex items-center justify-center text-indigo-400 shadow-[0_0_12px_rgba(99,102,241,0.2)]">
            <Clock className="w-4 h-4" />
          </div>
          <h2 className="text-sm font-bold text-slate-100">Gemini Route Reasoning</h2>
          <p className="text-xs text-slate-400 leading-relaxed font-light">
