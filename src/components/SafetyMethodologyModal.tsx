      ...
      <div className="glass-panel-elevated w-full max-w-xl rounded-2xl p-5 sm:p-6 shadow-[0_20px_60px_rgba(0,0,0,0.7)] space-y-4 max-h-[85vh] overflow-y-auto border border-white/15 relative">
        <div className="flex items-center justify-between pb-3.5 border-b border-white/[0.08]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-100 drop-shadow-sm">Safety Scoring Methodology</h2>
              <p className="text-xs text-slate-400 font-light">How SafeRoute AI computes estimated safety scores</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Important Notice */}
        <div className="glass-card bg-amber-500/15 border border-amber-400/30 rounded-xl p-3.5 space-y-1.5 text-xs text-amber-200 shadow-sm">
          ...
          <p className="leading-relaxed font-light opacity-95">
            SafeRoute AI always expresses safety as an <strong className="font-semibold text-amber-200">estimated Safety Score out of 100</strong> (e.g., &quot;Safety Score: 88/100&quot;). We never display &quot;91% safe&quot; or claim absolute immunity from hazard. Always exercise personal situational awareness and sound judgment.
          </p>
        </div>

        {/* Factor Breakdown */}
        <div className="space-y-3">
          <h3 className="text-[10px] font-bold uppercase tracking-wider text-slate-300 font-mono">
            Primary Safety Factors Evaluated
          </h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div className="glass-card p-3.5 rounded-xl border border-white/[0.06] space-y-1.5">
        ...
        <div className="pt-2 flex justify-end border-t border-white/[0.06]">
          <button
            onClick={onClose}
            className="bg-emerald-600/90 hover:bg-emerald-500 text-white text-xs font-bold px-4 py-2 rounded-xl transition-all shadow-[0_0_12px_rgba(16,185,129,0.3)] border border-emerald-400/30 hover:scale-105 active:scale-95"
          >
            Understood
          </button>
        </div>
